...
> 🍀 All of this is done on Windows.
# DISCLAIMER
...
### CREATE DUMP FROM YOUR DEVICE!
 - If you want to do something from this you must create dump first. **otherwise you will not able to restore IMEI or your tablet from bricked state.**
 - To do that you must folow [Dump](#dump-all)

# All instructions are on the [wiki](https://github.com/LunaNyan/TB-330FU/wiki)
